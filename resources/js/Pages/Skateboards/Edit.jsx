...
export default function EditSkateboard({ errors, skateboard }) {

    //define state
    const [jenis_skateboard, setJenisSkateboard] = useState(skateboard.jenis_skateboard);
    const [merk, setMerk] = useState(skateboard.merk);
    const [harga, setHarga] = useState(skateboard.harga);
    const [keterangan, setKeterangan] = useState(skateboard.keterangan);
    ...
    //function "storePost"
    const updateSkateboard = async (e) => {
        e.preventDefault();

        Inertia.put(`/skateboards/${skateboard.id}`, {
                ...
                <div className="col-12">
                    <div className="card border-0 rounded shadow-sm border-top-success">
                        <div className="card-header">
                            <span className="font-weight-bold">EDIT SKATEBOARD</span>
                        </div>
                        <div className="card-body">
                            <form onSubmit={updateSkateboard}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <select className="form-control" name="jenis_skateboard" value={jenis_skateboard} onChange={(e) => setJenisSkateboard(e.target.value)} >
                                        <option value="">-- Pilih Jenis Skateboard --</option>
                                        {options.map((option) => (
                                ...
                                <div>
                                    ...
                                    {/* <button type="reset" className="btn btn-md btn-warning me">
